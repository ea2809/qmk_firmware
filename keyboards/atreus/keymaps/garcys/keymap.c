...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUMS] = LAYOUT(
    ...
    _______, _______, KC_DOT,  KC_COMM, CM_SCLN,                   KC_RPRN, KC_1, KC_2,   KC_3,   KC_MINS,
  ...
  [SYMB] = LAYOUT(
    KC_BSLS, KC_EXLM, KC_LABK, KC_RABK, CM_COLN,                   KC_UNDS, KC_DLR,  KC_QUES, _______, KC_PERC,
    KC_AT,   KC_AMPR, KC_LPRN, KC_RPRN, CM_SCLN,                   KC_COMM, KC_DOT,  KC_QUOT, ooooooo, KC_TILD,
